    ...
    def __init__(self, session_id: str, retriever=None):
        try:
            ...
            if retriever is None:
                raise ValueError("Retriever cannot be Nose")
            ...
            self.log.error("Failed to initialise ConversationalRAG", error=str(e))
            raise DocumentPortalException("Failed to initialise ConversationalRAG", sys)
    ...
    def load_retriever_from_faiss(self, index_path: str):
        ...
        try:
            ...
            if not os.path.isdir(index_path):
                raise FileNotFoundError(f"FAISS index directory does not found: {index_path}")
            ...
            raise DocumentPortalException("Loading error in ConversationlRAG", sys)
